...
@section('content')
    <div class="flex items-center gap-4 mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800">Tambah Toping Baru</h2>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6 max-w-2xl">
        <form action="{{ route('admin.topping.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_topping" class="w-full border rounded-lg p-2" placeholder="Contoh: Bubble" required>
            </div>
